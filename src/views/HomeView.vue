          ...
          <div class="columns">
            <div class="column has-text-centered">
              ...
              <p v-if="totalTime >= 1440" class="title has-text-primary">
                {{ Math.floor(totalTime/1440) }} {{ Math.floor(totalTime/1440) <= 1 ? 'day' : 'days' }}, {{ Math.floor((totalTime%1440)/60) }} {{ Math.floor((totalTime%1440)/60) <= 1 ? 'hour' : 'hours' }}, {{ totalTime%60 }} {{ totalTime%60 <= 1 ? 'min' : 'mins' }}
              </p>
              <p v-else-if="totalTime >= 60" class="title">
                {{ Math.floor(totalTime/60) }} {{ Math.floor(totalTime/60) <= 1 ? 'hour' : 'hours' }}, {{ totalTime%60 }} {{ totalTime%60 <= 1 ? 'min' : 'mins' }}
              </p>
